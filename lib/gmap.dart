...
class _GmapState extends State<Gmap> {
  ...
  void _setMarkerIcon()async{
    _markerIcon = await BitmapDescriptor.fromAssetImage(ImageConfiguration(),'assets/small-axe.png');
  }
  ...
  void _setMapStyle () async {
    String style = await DefaultAssetBundle.of(context).loadString('assets/googlemaps.json');
